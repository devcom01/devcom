...
const resume = (props) => {
  ...
  // each one of them is an array * . map *
  useEffect(() => console.log(educations,contacts,experiences,profil), [educations,contacts,experiences,profil]);
  const ref=useRef()
  return (
    <div>
...
<ReactPrint trigger={()=>
 ...
 Download
      ...
      <div  ref={ref} class="flex items-center justify-center mt-5">
        <div class="bg-blue-900 w-1/8 p-10 h-auto ">
          ...
          <hr class="w-1/6 mb-5" />
            ...
            {contacts[0] && (
          <h1 class="text-gray-400 text-sm"> {contacts[0].Email}</h1>)}
           {contacts[0] && (
          <h1 class="text-gray-400 text-sm">{contacts[0].Linkedin}</h1>)}
           {contacts[0] && (
          <h1 class="text-gray-400 text-sm">{contacts[0].Github}</h1>)}
           {contacts[0] && (
          <h1 class="text-gray-400 text-sm">{contacts[0].Phone}</h1>)}
                     {contacts[0] && (
          <h1 class="text-gray-400 text-sm">{contacts[0].Adress}</h1>)}
          <hr class="my-5" />
...
<h1 class="text-gray-400 text-sm uppercase font-semibold tracking-wider">
          ...
          <h1 class="text-gray-500 text-sm">
            <span class="italic">{ed.university}</span>,
            <span class="text-gray-400 font-semibold italic">{ed.city}</span>
            /{ed.dates}-{ed.datef} 
          ...
          <h1 class="text-gray-500 text-sm">
            {educations.map((ed) => (
            <span class="italic">{ed.university}</span> ,
             <span class="text-gray-400 font-semibold italic">{ed.university}</span>))}
        ...
        <div class="bg-white w-7/12 p-10 h-auto">
          <h1 class="text-gray-500">
            ...
            ABC company to maximize brand awareness and revenue through
            integrated marketing communications.
          </h1>
          <h1 class="font-semibold uppercase tracking-wider my-6 text-gray-500">
            Experience
          </h1>
...
{ed.university}
          ...
          <h1 class="text-gray-500 text-sm">
          <p class=""> {ed.diploma}    {ed.dates} {ed.datef} </p>
            <br/>
            <p class="">{ed.city}</p>
		...
		<div class="box-2">
			...
			<div class="intro">
      {contacts[0] && (
				<h1>{contacts[0].Firstname} {contacts[0].Lastname}</h1>)}

{contacts[0] && (
				<p>{contacts[0].JobTitle}</p>)}
        {profil[0]&& (
      <p class="head">{profil[0].about}</p> )}
        ...
        {experiences[0]&& (
          ...
          {experiences.map((ed) => (
           <div>
				<p class="para-1">{ed.job}  ({ed.dates} -- {ed.datef})</p> 
