...
<div class=" px-10 my-4 py-6 bg-white rounded-lg shadow-md">
                ...
                <div class="flex items-center space-x-2 mt-2">
                    <p class="text-2xl text-gray-900 mt-5 mx-4 font-extrabold">Proxym Group</p>
                    
                </div>
                <p class="text-gray-500 leading-loose font-medium mt-3 tracking-wide">Unleash Your Digital Potential !</p>
...
<div class="flex-1 bg-white rounded-lg shadow-xl p-8">
                    ...
                    <ul class="mt-2 text-gray-700">
                        <li class="flex border-y py-2">
                            ...
                            <a href="http://www.proxym-group.com/"class="text-blue-600 underline">http://www.proxym-group.com/</a>
                        </li>
                        <li class="flex border-b py-2">
                            <span class="font-bold w-24">Phone:</span>
                            <span class="text-gray-700"> +216 36 01 50 50</span>
                        </li>
                        <li class="flex border-b py-2">
                            <span class="font-bold w-24">Email:</span>
                            <span class="text-gray-700">contact@proxym-group.com</span>
                        </li>
                        <li class="flex border-b py-2">
                            <span class="font-bold w-24">Adress</span>
                            <span class="text-gray-700">Technopole de Sousse 4051 Sousse</span>
                        </li>
                        <li class="flex border-b py-2">
                            <span class="font-bold w-24">Industry:</span>
                            <span class="text-gray-700">IT Services and IT Consulting</span>
                        </li>
                        <li class="flex border-b py-2">
                            <span class="font-bold w-50">Company size:</span>
                            <span class="text-gray-700 mx-4">201-500 employees</span>
                        </li>
                        <li class="flex border-b py-2">
                            <span class="font-bold w-24">Founded:</span>
                            <span class="text-gray-700">2006</span>
                        </li>
...
<div class="flex flex-col w-full 2xl:w-2/3">
                <div class="flex-1 bg-white rounded-lg shadow-xl p-8">
                    ...
                    <p class="mt-2 text-gray-700">Proxym Group is a global IT player recognized as a Digital Services provider in the areas of Smart Gov and Digital Finance.

With more than 600 successful Digital Projects & Satisfied Customers since 2006 and more than 200 Software engineers mobile on Europe, Africa and the Middle East, Proxym Group is at the heart of innovation as confirmed by its selection among IBM’s 100 Most Innovative Business Partners.</p>
                </div></div>
</div>
<div class="div4">
<div class="flex flex-col w-full 2xl:w-2/3">
                <div class="flex-1 bg-white rounded-lg shadow-xl p-8">
                    <h4 class="text-xl text-gray-900 font-bold">Specialties</h4>
                    <p class="mt-2 text-gray-700">E-Commerce, Développement mobile, Applications d'entreprises, E-gov, Smart Government, Digital Banking, Digital Financial Services, Digital Experience, User Experience, Digital Transformation , Product Management, Omnichannel Retail, Digital Services, API Management, Solutions Integrations, Consulting, Business Analyses, UI / UX Design, IoT Applications, RPA, AI & Machine Learning, and OCR</p>
                </div></div>
</div>
{/* 
<div class="h-full  bg-gray-200 p-8">
        <div class="bg-white rounded-lg shadow-xl pb-8">
            <div class="absolute  right-12 mt-4 rounded">
                ...
                <div class="bg-white absolute right-0 w-40 py-2 mt-1 border border-gray-200 shadow-2xl">
